...
| Key | Value |
|-----|-------|
| User table id | `tbl04vMl52pc7cErYz6` |
| Email field id | `fldRJYiuhWdCTYK7iJ8` |
| Schema file | `schema/table-tbl04vMl52pc7cErYz6.json` |
...
1. Read the user table schema (`schema/table-tbl04vMl52pc7cErYz6.json`) to find the target field IDs.
